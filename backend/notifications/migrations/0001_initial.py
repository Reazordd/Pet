    ...
    operations = [
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('verb', models.CharField(choices=[('message', 'Новое сообщение'), ('comment', 'Новый комментарий'), ('favorite', 'Добавлено в избранное'), ('review', 'Новый отзыв'), ('moderation', 'Объявление одобрено/отклонено'), ('other', 'Другое')], max_length=20)),
