...
class PetAdmin(admin.ModelAdmin):
    ...
    fields = (
        ...
        'offer_type', 'city', 'description', 'is_active',
        'moderation_status', 'rejection_reason', 'last_raised_at', 'created_at'
    )
    readonly_fields = ('created_at', 'last_raised_at')

    list_display = ('name', 'species', 'breed', 'price', 'city', 'user', 'moderation_status', 'is_active', 'created_at')
