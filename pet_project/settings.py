...
DEBUG = env.bool('DEBUG', default=True)  # Changed to True for development
...
INSTALLED_APPS = [
    ...
    'django.contrib.messages',  # Added for admin
...
MIDDLEWARE = [
    ...
    'django.contrib.auth.middleware.AuthenticationMiddleware',  # Added for admin
...
# Template configuration for Django Admin
TEMPLATES = [
    {
        'BACKEND': 'django.template.backends.django.DjangoTemplates',
        'DIRS': [BASE_DIR / 'templates'],  # Create templates directory if needed
        'APP_DIRS': True,
        'OPTIONS': {
            'context_processors': [
...
LANGUAGE_CODE = 'ru-ru'  # Changed to Russian
...
# Removed STATICFILES_DIRS since the directory doesn't exist yet
